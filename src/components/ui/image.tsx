...
interface BaseImageProps extends Omit<
...
type ImageProps = BaseImageProps &
  (
    | {
        /** Fill parent container (absolute positioning + object-fit) */ fill: true
        width?: never
        height?: never
      }
    | {
        fill?: false
        /** Intrinsic width in px */ width: number
        /** Intrinsic height in px */ height: number
      }
  )
